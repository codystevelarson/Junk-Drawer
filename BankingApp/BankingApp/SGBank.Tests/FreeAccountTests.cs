...
namespace SGBank.Tests
{
    ...
    class FreeAccountTests
    {
        ...
        [TestCase("12345", "FreeAccount", 100, AccountType.Free, 50, false)]
        [TestCase("12345", "FreeAccount", 250, AccountType.Free, -150, false)]
        [TestCase("12345", "FreeAccount", 100, AccountType.Basic, -50, false)]
        [TestCase("12345", "FreeAccount", 25, AccountType.Free, -50, false)]
        [TestCase("12345", "FreeAccount", 100, AccountType.Free, -50, true)]
